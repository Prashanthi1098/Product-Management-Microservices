...
public class ProductServiceImpl implements ProductService 
{
	...
	public ProductPojo addProduct(ProductPojo productPojo) 
	{
		...
		{
			//ProductEntity productEntity =new ProductEntity(productPojo.getId(),productPojo.getName(),productPojo.getImage(),productPojo.getPrice(),productPojo.getQuantity(),productPojo.getDescription(),null);
